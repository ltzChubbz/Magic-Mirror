	...
	modules: [
		...
		},
		{
			...
			config: {
				...
				calendars: [
					{
					url: 'https://calendar.google.com/calendar/ical/v2pkoq4mo86jthfkn0nthoq108%40group.calendar.google.com/public/basic.ics',
					symbol: 'calendar',
						auth: {
						    user: 'username',
		...
		},
		 {
                        ...
                        config: {
                                feeds: [
                                        {
                                                title: "ABC World",
                                                url: "http://www.abc.net.au/news/feed/668/rss.xml"
                                        }
                                ],
                                showSourceTitle: true,
                                showPublishDate: true
